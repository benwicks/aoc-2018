...
import com.exsilicium.aoc2018.Day01.PUZZLE_INPUT

internal fun main(args: Array<String>) {
    println("Day 01 Pt. One Answer:\t" + Day01.sumFrequenciesInList(PUZZLE_INPUT))
    println("Day 01 Pt. Two Answer:\t" + Day01.findFirstDuplicateFrequency(PUZZLE_INPUT))
}
...
+11
+7
-133358""".lineSequence().map(Integer::parseInt)
